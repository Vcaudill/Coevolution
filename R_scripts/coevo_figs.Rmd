...
snake_change_cor<- read.csv("cost_grade/snake_change/all_cor.txt" , header = TRUE)
...
newt_change_cor<- read.csv("cost_grade/newt_change/all_cor.txt" , header = TRUE)
...
no_hair_lit<- read.csv("flat_map/no_hair/all_lit.txt" , header = TRUE)
